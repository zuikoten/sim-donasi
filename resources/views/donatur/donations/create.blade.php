            ...
            <div class="card-body">
                <form method="POST" action="{{ route('donations.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('program_id') is-invalid @enderror" id="program_id" name="program_id" >
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('metode_pembayaran') is-invalid @enderror" id="metode_pembayaran" name="metode_pembayaran" required>
                            ...
                            <option value="Uang Tunai" {{ old('metode_pembayaran') == 'Uang Tunai' ? 'selected' : '' }}>Uang Tunai</option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('keterangan_tambahan') is-invalid @enderror" id="keterangan_tambahan" name="keterangan_tambahan" rows="2" placeholder="Contoh: Ditransfer via Bank BCA an. John Doe">{{ old('keterangan_tambahan') }}</textarea>
