...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        ...
        @if(auth()->user()->notifications()->where('status_baca', true)->exists())
            <form action="{{ route('notifications.deleteAllRead') }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus semua notifikasi yang sudah dibaca?')">
                @csrf
                @method('DELETE')
...
<div class="card">
    <div class="card-body">
        @forelse(auth()->user()->notifications()->orderBy('created_at', 'desc')->get() as $notification)
            <div class="list-group-item p-3 mb-2 @if(!$notification->status_baca) border-start border-4 border-primary @endif">
