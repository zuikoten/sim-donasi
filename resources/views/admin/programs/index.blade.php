                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="sort" name="sort" class="form-select form-select-sm">
                            <option value="dana_desc" {{ request('sort') == 'dana_desc' ? 'selected' : '' }}>Dana Terkumpul
                                Terbesar → Terkecil</option>
                            <option value="dana_asc" {{ request('sort') == 'dana_asc' ? 'selected' : '' }}>Dana Terkumpul
                                Terkecil → Terbesar</option>
                            <option value="target_desc" {{ request('sort') == 'target_desc' ? 'selected' : '' }}>Target Dana
                                Terbesar → Terkecil</option>
                            <option value="target_asc" {{ request('sort') == 'target_asc' ? 'selected' : '' }}>Target Dana
                                Terkecil → Terbesar</option>
                        </select>
                    </div>
