...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2 ">Detail Pengguna: <span
                class="text-primary">{{ $user->profile->nama_lengkap ?? 'Belum Lengkapi Data Profil' }}
                &#40;{{ $user->name }}&#41;</span></h1>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('users.index') }}" class="btn btn-sm btn-secondary me-2">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="mb-2">Total Donasi:</p>
                    <h4>{{ $user->donations->count() }} Kali</h4>
                    <hr>
                    <p class="mb-2">Total Nominal (Terverifikasi):</p>
                    <h5>Rp
                        {{ number_format($user->donations->where('status', 'terverifikasi')->sum('nominal'), 0, ',', '.') }}
                    </h5>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content shadow-lg border-0 rounded-4">
                <div class="modal-header bg-primary text-white rounded-top-4">
                    <h5 class="modal-title fw-bold" id="editProfileModalLabel">
                        ...
                        {{ $user->profile->nama_lengkap ?? 'Belum Lengkapi Data Profil' }}
                    </h5>
