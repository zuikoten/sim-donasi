            ...
            <div class="card-body text-center">
                @if($donation->bukti_transfer)
                    <a href="{{ Storage::url($donation->bukti_transfer) }}" target="_blank">
                        <img src="{{ Storage::url($donation->bukti_transfer) }}" alt="Bukti Transfer" class="img-fluid rounded" style="max-height: 300px;">
                    </a>
                    <p class="mt-2">
                        <a href="{{ Storage::url($donation->bukti_transfer) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat Gambar Asli</a>
                    </p>
                @else
