        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <div class="mb-4">
                        @if ($program->gambar)
                            <img src="{{ Storage::url($program->gambar) }}" class="img-fluid rounded"
                                style="height: 30vh; width: 100%; object-fit: cover; object-position: center;"
                                alt="{{ $program->nama_program }}">
                        @else
                            <img src="https://picsum.photos/seed/{{ $program->id }}/1200/400.jpg" class="img-fluid rounded"
                                style="height: 30vh; width: 100%; object-fit: cover; object-position: center;"
                                alt="{{ $program->nama_program }}">
                        @endif
                    </div>
                    ...
                    <div class="d-flex align-items-center mt-3">
                        ...
                        <span class="badge bg-light text-dark">
                            <i class="bi bi-calendar"></i> {{ $program->tanggal_mulai->format('d M Y') }} -
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <span>Rp {{ number_format($totalDonasiProgram, 0, ',', '.') }}</span>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>Rp {{ number_format($totalDonasiProgram, 0, ',', '.') }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body d-flex flex-column">
                                <span
                                    class="badge bg-primary mb-2 align-self-start">{{ $relatedProgram->kategori }}</span>
